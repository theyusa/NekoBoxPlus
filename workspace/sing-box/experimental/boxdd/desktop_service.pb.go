...
const file_experimental_boxdd_desktop_service_proto_rawDesc = "" +
	...
	"\x1fINSTALL_UPDATE_RESULT_NOT_NEWER\x10\x032\xf0\x11\n" +
...
var file_experimental_boxdd_desktop_service_proto_depIdxs = []int32{
	...
	33, // 26: desktop.DesktopService.ListPowerReports:input_type -> google.protobuf.Empty
	...
	33, // 31: desktop.DesktopService.DeleteAllPowerReports:input_type -> google.protobuf.Empty
	31, // 32: desktop.DesktopService.InstallUpdate:input_type -> desktop.InstallUpdateRequest
	33, // 33: desktop.DesktopService.GetDataProtection:input_type -> google.protobuf.Empty
	27, // 34: desktop.DesktopService.SetDataProtection:input_type -> desktop.SetDataProtectionRequest
	33, // 35: desktop.DesktopService.GetSecuritySettings:input_type -> google.protobuf.Empty
	29, // 36: desktop.DesktopService.SetInsecureModeEnabled:input_type -> desktop.SetInsecureModeEnabledRequest
	30, // 37: desktop.DesktopService.SetLocale:input_type -> desktop.SetLocaleRequest
	9,  // 38: desktop.ApplicationService.CheckConfig:input_type -> desktop.ConfigContent
	9,  // 39: desktop.ApplicationService.FormatConfig:input_type -> desktop.ConfigContent
	33, // 40: desktop.ApplicationService.GenerateConfigSchema:input_type -> google.protobuf.Empty
	10, // 41: desktop.ApplicationService.EncodeProfile:input_type -> desktop.ProfileContent
	11, // 42: desktop.ApplicationService.DecodeProfile:input_type -> desktop.ProfileData
	3,  // 43: desktop.ApplicationService.ArchiveReport:input_type -> desktop.ArchiveReportRequest
	4,  // 44: desktop.ApplicationService.StartStandaloneNetworkQualityTest:input_type -> desktop.StandaloneNetworkQualityTestRequest
	5,  // 45: desktop.ApplicationService.StartStandaloneSTUNTest:input_type -> desktop.StandaloneSTUNTestRequest
	6,  // 46: desktop.DesktopService.GetDaemonInfo:output_type -> desktop.DaemonInfo
	33, // 47: desktop.DesktopService.ClaimService:output_type -> google.protobuf.Empty
	33, // 48: desktop.DesktopService.TakeOverService:output_type -> google.protobuf.Empty
	33, // 49: desktop.DesktopService.StartService:output_type -> google.protobuf.Empty
	12, // 50: desktop.DesktopService.GetWorkingDirectory:output_type -> desktop.WorkingDirectoryInfo
	33, // 51: desktop.DesktopService.DestroyWorkingDirectory:output_type -> google.protobuf.Empty
	13, // 52: desktop.DesktopService.ListCrashReports:output_type -> desktop.CrashReportList
	17, // 53: desktop.DesktopService.ReadCrashReport:output_type -> desktop.CrashReportContent
	33, // 54: desktop.DesktopService.MarkCrashReportRead:output_type -> google.protobuf.Empty
	19, // 55: desktop.DesktopService.ExportCrashReport:output_type -> desktop.CrashReportArchive
	33, // 56: desktop.DesktopService.DeleteCrashReport:output_type -> google.protobuf.Empty
	33, // 57: desktop.DesktopService.DeleteAllCrashReports:output_type -> google.protobuf.Empty
	20, // 58: desktop.DesktopService.ListOOMReports:output_type -> desktop.OOMReportList
	24, // 59: desktop.DesktopService.ReadOOMReport:output_type -> desktop.OOMReportContent
	33, // 60: desktop.DesktopService.MarkOOMReportRead:output_type -> google.protobuf.Empty
	19, // 61: desktop.DesktopService.ExportOOMReport:output_type -> desktop.CrashReportArchive
	33, // 62: desktop.DesktopService.DeleteOOMReport:output_type -> google.protobuf.Empty
	33, // 63: desktop.DesktopService.DeleteAllOOMReports:output_type -> google.protobuf.Empty
	20, // 64: desktop.DesktopService.ListPowerReports:output_type -> desktop.OOMReportList
	24, // 65: desktop.DesktopService.ReadPowerReport:output_type -> desktop.OOMReportContent
	33, // 66: desktop.DesktopService.MarkPowerReportRead:output_type -> google.protobuf.Empty
	19, // 67: desktop.DesktopService.ExportPowerReport:output_type -> desktop.CrashReportArchive
	33, // 68: desktop.DesktopService.DeletePowerReport:output_type -> google.protobuf.Empty
	33, // 69: desktop.DesktopService.DeleteAllPowerReports:output_type -> google.protobuf.Empty
	32, // 70: desktop.DesktopService.InstallUpdate:output_type -> desktop.InstallUpdateResponse
	26, // 71: desktop.DesktopService.GetDataProtection:output_type -> desktop.DataProtectionInfo
	26, // 72: desktop.DesktopService.SetDataProtection:output_type -> desktop.DataProtectionInfo
	28, // 73: desktop.DesktopService.GetSecuritySettings:output_type -> desktop.SecuritySettings
	33, // 74: desktop.DesktopService.SetInsecureModeEnabled:output_type -> google.protobuf.Empty
	33, // 75: desktop.DesktopService.SetLocale:output_type -> google.protobuf.Empty
	33, // 76: desktop.ApplicationService.CheckConfig:output_type -> google.protobuf.Empty
	9,  // 77: desktop.ApplicationService.FormatConfig:output_type -> desktop.ConfigContent
	9,  // 78: desktop.ApplicationService.GenerateConfigSchema:output_type -> desktop.ConfigContent
	11, // 79: desktop.ApplicationService.EncodeProfile:output_type -> desktop.ProfileData
	10, // 80: desktop.ApplicationService.DecodeProfile:output_type -> desktop.ProfileContent
	33, // 81: desktop.ApplicationService.ArchiveReport:output_type -> google.protobuf.Empty
	34, // 82: desktop.ApplicationService.StartStandaloneNetworkQualityTest:output_type -> daemon.NetworkQualityTestProgress
	35, // 83: desktop.ApplicationService.StartStandaloneSTUNTest:output_type -> daemon.STUNTestProgress
